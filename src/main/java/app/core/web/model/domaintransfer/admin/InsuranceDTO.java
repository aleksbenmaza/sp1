package app.core.web.model.domaintransfer.admin;
 ...
 */
public class InsuranceDTO extends app.core.web.model.domaintransfer.publik.InsuranceDTO {
    ...
    public InsuranceDTO(app.core.business.model.mapping.Insurance insurance) {
        super(insurance);
