...
public class Errors extends HashMap<String, String> {
    ...
    private static final HashMap<Class<? extends Serializable>, HashSet<Entry>> commandsFieldsErrors;

    private Class<? extends Serializable> clazz;

    static {
        commandsFieldsErrors = new HashMap<>();
    }
    ...
    public Errors(Class<? extends Serializable> clazz) {
        super();
        this.clazz = clazz;
        init();
    }
    ...
    public void rejectValue(String fieldName, String message) {
      ...
      for(Map.Entry<Class<? extends Serializable>, HashSet<Entry>> entry : commandsFieldsErrors.entrySet())
    ...
    private static void fullFill(Class<? extends Serializable> commandClass) {
